...
#     update_data_thread.update_date.connect(dataTable.update_item_data)  # 链接信号
#     update_data_thread.start()
#
#     # 显示在屏幕中央
#     desktop = QApplication.desktop()  # 获取坐标
#     x = (desktop.width() - dataTable.width()) // 2
#     y = (desktop.height() - dataTable.height()) // 2
#     dataTable.move(x, y)  # 移动
#
#     # 显示表格
#     dataTable.show()
#     app.exit(app.exec_())